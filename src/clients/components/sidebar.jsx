	...
	return (
		<>
			<div className="sidebar relative">
				<div
					className={`absolute top-5 left-4 z-50 flex h-[50px] w-[50px] items-center justify-center rounded-full border-2 border-slate-200 bg-transparent hover:bg-white ${
						props.isShowSidebar
			...
			>
				<div className="sidebar__button-create relative mb-2">
					...
					<div
						className={`absolute z-[999] ml-[15px] mt-[10px] h-auto w-[150px] rounded-lg border-[1px] border-slate-200 bg-white shadow-lg shadow-slate-400 ${
							isShowCreate
